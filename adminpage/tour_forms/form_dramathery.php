...
$tour_name = 'dramathery';
$tour_title = 'Drama therey';
$destination = 'Kolkaata';
$duration = '6';
//$tour_id = 6;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && !isset($_POST['search_nic'])) {
    ...
    try {
        ...
        $visa_request_letter = handleFileUpload('visaRequestLetter', $surname, $othername, 'visa_request_letter', $tour_name);
        $bank_statements = handleFileUpload('bankStatements', $surname, $othername, 'bank_statements', $tour_name);
        $employment_letter = handleFileUpload('employmentLetter', $surname, $othername, 'employment_letter', $tour_name);
        $epf_confirmation = handleFileUpload('epfConfirmation', $surname, $othername, 'epf_confirmation', $tour_name);
        $pay_slips = handleMultipleFileUploads('paySlips', $surname, $othername, 'pay_slip', $tour_name);
        $business_registration = handleFileUpload('businessRegistration', $surname, $othername, 'business_registration', $tour_name);
        $form_pvt_ltd = handleFileUpload('formPvtLtd', $surname, $othername, 'form_pvt_ltd', $tour_name);
        ...
        $student_letter = handleFileUpload('studentLetter', $surname, $othername, 'student_letter', $tour_name);
        $dependent_confirmation = handleFileUpload('dependentConfirmation', $surname, $othername, 'dependent_confirmation', $tour_name);
        $dependent_income = handleFileUpload('dependentIncome', $surname, $othername, 'dependent_income', $tour_name);
        ...
        if ($record_exists) {
            ...
            $fields = array(
                ...
                'tourname' => $tour_name, // IMPORTANT: Add tour name to record
