...
<body style="background-color:black;">
    <div class="bgimg">
        <div class="topleft">
            <img src="../img/logo.png" style="width: 200px; height: auto;" alt="EduTourism Logo">
        </div>
        <div class="middle">
            <h1>COMING SOON</h1>
            <hr>
            ...
            if (!messageDiv) {
                ...
                messageDiv.innerHTML = `
                    ...
                    <div style="margin-right: 20px;">
                        ...
                        <p style="margin: 10px 0; font-size: 14px;">Redirecting to Home  in <span class="countdown-number">${countdown}</span> seconds...</p>
